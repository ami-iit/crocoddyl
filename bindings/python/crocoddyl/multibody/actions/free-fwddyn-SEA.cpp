...
void exposeDifferentialActionFreeFwdDynamicsSEA() {
  bp::register_ptr_to_python<boost::shared_ptr<DifferentialActionModelFreeFwdDynamicsSEA> >();

  bp::class_<DifferentialActionModelFreeFwdDynamicsSEA, bp::bases<DifferentialActionModelAbstract> >(
      "DifferentialActionModelFreeFwdDynamicsSEA",
      ...
      .def<void (DifferentialActionModelFreeFwdDynamicsSEA::*)(const boost::shared_ptr<DifferentialActionDataAbstract>&,
                                                            const Eigen::Ref<const Eigen::VectorXd>&,
                                                            const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &DifferentialActionModelFreeFwdDynamicsSEA::calc, bp::args("self", "data", "x", "u"),
      ...
      .def<void (DifferentialActionModelFreeFwdDynamicsSEA::*)(const boost::shared_ptr<DifferentialActionDataAbstract>&,
                                                            const Eigen::Ref<const Eigen::VectorXd>&,
                                                            const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &DifferentialActionModelFreeFwdDynamicsSEA::calcDiff, bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &DifferentialActionModelFreeFwdDynamicsSEA::createData, bp::args("self"),
           "Create the free forward dynamics differential action data.")
      .add_property(
          "pinocchio",
          bp::make_function(&DifferentialActionModelFreeFwdDynamicsSEA::get_pinocchio, bp::return_internal_reference<>()),
          "multibody model (i.e. pinocchio model)")
      .add_property("actuation",
                    bp::make_function(&DifferentialActionModelFreeFwdDynamicsSEA::get_actuation,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "actuation model")
      .add_property("costs",
                    bp::make_function(&DifferentialActionModelFreeFwdDynamicsSEA::get_costs,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "total cost model")
      .add_property(
          "armature",
          bp::make_function(&DifferentialActionModelFreeFwdDynamicsSEA::get_armature, bp::return_internal_reference<>()),
          bp::make_function(&DifferentialActionModelFreeFwdDynamicsSEA::set_armature),
  ...
  bp::class_<DifferentialActionDataFreeFwdDynamics, bp::bases<DifferentialActionDataAbstract> >(
      ...
      bp::init<DifferentialActionModelFreeFwdDynamicsSEA*>(bp::args("self", "model"),
