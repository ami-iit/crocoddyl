...
void exposeDifferentialActionContactFwdDynamicsSEA() {
  bp::register_ptr_to_python<boost::shared_ptr<DifferentialActionModelContactFwdDynamicsSEA> >();

  bp::class_<DifferentialActionModelContactFwdDynamicsSEA, bp::bases<DifferentialActionModelAbstract> >(
      "DifferentialActionModelContactFwdDynamicsSEA",
      ...
      .def<void (DifferentialActionModelContactFwdDynamicsSEA::*)(
          const boost::shared_ptr<DifferentialActionDataAbstract>&, const Eigen::Ref<const Eigen::VectorXd>&,
          const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &DifferentialActionModelContactFwdDynamicsSEA::calc, bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &DifferentialActionModelContactFwdDynamicsSEA::createData, bp::args("self"),
           "Create the contact forward dynamics differential action data.")
      .add_property("pinocchio",
                    bp::make_function(&DifferentialActionModelContactFwdDynamicsSEA::get_pinocchio,
                                      bp::return_internal_reference<>()),
                    "multibody model (i.e. pinocchio model)")
      .add_property("actuation",
                    bp::make_function(&DifferentialActionModelContactFwdDynamicsSEA::get_actuation,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "actuation model")
      .add_property("contacts",
                    bp::make_function(&DifferentialActionModelContactFwdDynamicsSEA::get_contacts,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "multiple contact model")
      .add_property("costs",
                    bp::make_function(&DifferentialActionModelContactFwdDynamicsSEA::get_costs,
                                      bp::return_value_policy<bp::return_by_value>()),
                    "total cost model")
      .add_property("armature",
                    bp::make_function(&DifferentialActionModelContactFwdDynamicsSEA::get_armature,
                                      bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&DifferentialActionModelContactFwdDynamicsSEA::set_armature),
                    "set an armature mechanism in the joints")
      .add_property("JMinvJt_damping",
                    bp::make_function(&DifferentialActionModelContactFwdDynamicsSEA::get_damping_factor),
                    bp::make_function(&DifferentialActionModelContactFwdDynamicsSEA::set_damping_factor),
  ...
  bp::class_<DifferentialActionDataContactFwdDynamics, bp::bases<DifferentialActionDataAbstract> >(
      ...
      bp::init<DifferentialActionModelContactFwdDynamicsSEA*>(bp::args("self", "model"),
