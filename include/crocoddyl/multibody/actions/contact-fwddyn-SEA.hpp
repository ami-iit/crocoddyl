...
class DifferentialActionModelContactFwdDynamicsSEATpl : public DifferentialActionModelAbstractTpl<_Scalar> {
 public:
  ...
  DifferentialActionModelContactFwdDynamicsSEATpl(boost::shared_ptr<StateMultibody> state,
  ...
  virtual ~DifferentialActionModelContactFwdDynamicsSEATpl();
