...
class DifferentialActionModelFreeFwdDynamicsSEATpl : public DifferentialActionModelAbstractTpl<_Scalar> {
 public:
  ...
  DifferentialActionModelFreeFwdDynamicsSEATpl(boost::shared_ptr<StateMultibody> state,
                                            boost::shared_ptr<ActuationModelAbstract> actuation,
                                            boost::shared_ptr<CostModelSum> costs);
  virtual ~DifferentialActionModelFreeFwdDynamicsSEATpl();
